<x-layouts.base :title="$title ?? 'Dashboard - Admin'">
            ...
            <div class="d-flex flex-column flex-grow-1 overflow-auto bg-white border-end">
                ...
                <div class="d-flex align-items-center h-100px flex-shrink-0 px-3 border-bottom" style="height: 4rem;">
                    <a href="/" class="text-decoration-none fs-5 fw-bold text-dark">
                        Vale do Sol <span class="fs-6 fw-normal text-secondary">Admin</span>
                    </a>
                </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if(Auth::user()->seller && Auth::user()->seller->status === 'active')
                            <a href="{{ route('seller.dashboard') }}"
                               class="btn btn-sm btn-outline-primary d-none d-sm-inline-flex align-items-center gap-2">
