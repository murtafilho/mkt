<x-layouts.base :title="$title ?? 'Dashboard - Vendedor'">
            ...
            <div class="d-flex flex-column flex-grow-1 overflow-auto bg-white border-end">
                ...
                <div class="d-flex align-items-center flex-shrink-0 px-3 border-bottom" style="height: 4rem;">
                    <a href="/" class="text-decoration-none fs-5 fw-bold text-dark">
                        Vale do Sol <span class="fs-6 fw-normal text-secondary">Vendedor</span>
                    </a>
                </div>
        ...
        <div class="d-flex flex-column flex-grow-1">
            ...
            <header class="bg-white shadow-sm border-bottom">
                <div class="d-flex align-items-center justify-content-between px-3 px-lg-4" style="height: 4rem;">
                    ...
                    <button type="button" class="btn btn-link text-secondary p-0 d-md-none" x-data @click="$dispatch('toggle-sidebar')">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        @if(Auth::user()->hasRole('admin'))
                            <a href="{{ route('admin.dashboard') }}"
                               class="btn btn-sm btn-outline-warning d-none d-sm-inline-flex align-items-center gap-2">
    ...
    <div x-data="{ open: false }" @toggle-sidebar.window="open = !open" x-show="open" class="position-fixed top-0 start-0 w-100 h-100 d-md-none" style="z-index: 1050;" x-cloak>
        {{-- Backdrop --}}
        <div @click="open = false" class="position-fixed top-0 start-0 w-100 h-100 bg-dark" style="opacity: 0.5;" x-show="open"></div>

        {{-- Sidebar Panel --}}
        <div class="position-fixed top-0 start-0 h-100 bg-white d-flex flex-column" style="width: 16rem;" x-show="open">
            <div class="d-flex align-items-center justify-content-between px-3 border-bottom" style="height: 4rem;">
                <a href="/" class="text-decoration-none fs-5 fw-bold text-dark">
                    Vale do Sol <span class="fs-6 fw-normal text-secondary">Vendedor</span>
                </a>
                <button @click="open = false" class="btn btn-link text-secondary p-0">
                    <svg width="24" height="24" fill="none" stroke="currentColor" viewBox="0 0 24 24">
